 ...
 * ad_sdadc_open() call.
 *
 *\note This function applies i/o configuration for both positive and negative pins.
 * In case SDADC requires only the positive side, the negative pin in \ref ad_sdadc_io_conf_t
 * can be set to \ref HW_GPIO_PORT_NONE / \ref HW_GPIO_PIN_NONE.
 *

...
int ad_iso7816_io_config (const ad_iso7816_io_conf_t *io, AD_IO_CONF_STATE state)
{
        ...
        if (ad_io_configure(&io->rst, AD_ISO7816_IO_SIZE, io->voltage_level, state) !=
                                                                                AD_IO_ERROR_NONE) {
                return AD_ISO7816_ERROR_IO_CFG_INVALID;
        }
        ad_io_set_pad_latch(&io->rst, AD_ISO7816_IO_SIZE, AD_IO_PAD_LATCHES_OP_TOGGLE);
        hw_sys_pd_com_disable();
...
{
        if (ad_io_configure(&io->rst, AD_ISO7816_IO_SIZE, io->voltage_level,
                                                        AD_IO_CONF_ON) == AD_IO_ERROR_NONE) {
                ad_io_set_pad_latch(&io->rst, AD_ISO7816_IO_SIZE,
...
static void ad_iso7816_gpio_deconfigure(const ad_iso7816_io_conf_t *io)
{
        ...
        if (ad_io_configure(&io->rst, AD_ISO7816_IO_SIZE, io->voltage_level,
                                                AD_IO_CONF_OFF) == AD_IO_ERROR_NONE) {
                ad_io_set_pad_latch(&io->rst, AD_ISO7816_IO_SIZE,

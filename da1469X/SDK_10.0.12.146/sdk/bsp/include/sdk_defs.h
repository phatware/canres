...
typedef void (*assertion_func_t)(void);
...
/**
 * \brief Macro to convert time (in nsec) to system clock cycles
 *
 * \param[in] nsec      Time in nsec
 * \param[in] clk_freq  System Clock Frequency
 */
#define NSEC_TO_CLK_CYCLES(nsec, clk_freq)      ((((nsec) * ((clk_freq) / 10000)) + 99999) / 100000)

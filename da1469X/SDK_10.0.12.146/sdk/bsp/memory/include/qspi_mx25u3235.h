...
static void flash_mx25u3235_sys_clock_cfg(__UNUSED HW_QSPIC_ID id, __UNUSED sys_clk_t sys_clk);
static uint8_t flash_mx25u3235_get_dummy_bytes(__UNUSED HW_QSPIC_ID id, __UNUSED sys_clk_t sys_clk);
...
static const qspi_flash_config_t flash_mx25u3235_config = {
        ...
        .read_cs_idle_delay_ns         = 5,
        .erase_cs_idle_delay_ns        = 30,
        .qpi_mode                      = false,
        .is_ram                        = false,
...
__RETAINED_CODE static void flash_mx25u3235_sys_clock_cfg(__UNUSED HW_QSPIC_ID id, __UNUSED sys_clk_t sys_clk)
{

}

__RETAINED_CODE static uint8_t flash_mx25u3235_get_dummy_bytes(__UNUSED HW_QSPIC_ID id, __UNUSED sys_clk_t sys_clk)
{
        return 2;
}

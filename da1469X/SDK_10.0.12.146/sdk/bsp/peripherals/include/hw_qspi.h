...
{
        ASSERT_WARNING(clock_cycles < 32);
...
__STATIC_FORCEINLINE void hw_qspi_clock_disable(HW_QSPIC_ID id)
{
        ...
        if (id == HW_QSPIC) {
                ...
                uint32_t mask = (1 << HW_GPIO_PIN_0) | (1 << HW_GPIO_PIN_1) | (1 << HW_GPIO_PIN_2) |
                                (1 << HW_GPIO_PIN_3) | (1 << HW_GPIO_PIN_4) | (1 << HW_GPIO_PIN_5);

                REG_SETF(CRG_TOP, P0_SET_PAD_LATCH_REG, P0_SET_LATCH_EN, mask);
                REG_SETF(CRG_TOP, P0_RESET_PAD_LATCH_REG, P0_RESET_LATCH_EN, mask);
#endif
        } else {
                ASSERT_WARNING(0);
        }

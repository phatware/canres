...
typedef struct
{
        ...
        HW_DMA_PRIO     rx_dma_prio;      /*< DMA rx priority, which should be lower than DMA tx priority */
        HW_DMA_PRIO     tx_dma_prio;      /*< DMA tx priority, which should be greater than DMA rx priority */
        bool            use_dma;          /*< Use DMA */
        bool            acquired_rx_dma;  /*< RX DMA channels acquired */
        bool            acquired_tx_dma;  /*< TX DMA channels acquired */
#endif /* dg_configUSB_DMA_SUPPORT */
} usb_config;

...
/*
 * DEPRECATED GLOBAL/CONSTANT VARIABLES DEFINITIONS
 *****************************************************************************************
*/

DEPRECATED_LITERAL_MACRO(SMOTOR_IRQ_THRESHOLD_DEFAULT, "SMOTOR_IRQ_THRESHOLD_DEFAULT is deprecated")
#define SMOTOR_IRQ_THRESHOLD_DEFAULT (0x08 + SMOTOR_IRQ_THRESHOLD_DEFAULT)
DEPRECATED_LITERAL_MACRO(SMOTOR_MOI_DEFAULT, "SMOTOR_MOI_DEFAULT is deprecated")
#define SMOTOR_MOI_DEFAULT (0x100 + SMOTOR_MOI_DEFAULT)
DEPRECATED_LITERAL_MACRO(MAX_N_CMDs, "MAX_N_CMDs is deprecated, use HW_SMOTOR_MAX_ADDITIONAL_CMD instead")
#define MAX_N_CMDs (HW_SMOTOR_MAX_ADDITIONAL_CMD + MAX_N_CMDs)
DEPRECATED_LITERAL_MACRO(MAX_W_PTR, "MAX_W_PTR is deprecated, use HW_SMOTOR_WAVETABLE_LEN instead")
#define MAX_W_PTR  (HW_SMOTOR_WAVETABLE_LEN + MAX_W_PTR)
DEPRECATED_LITERAL_MACRO(MAX_PUN, "MAX_PUN is deprecated")
#define MAX_PUN (31 + MAX_PUN)
DEPRECATED_LITERAL_MACRO(MAX_TOD, "MAX_TOD is deprecated")
#define MAX_TOD (31 + MAX_TOD)
DEPRECATED_LITERAL_MACRO(WAVETABLE_LEN, "WAVETABLE_LEN is deprecated use HW_SMOTOR_WAVETABLE_LEN instead")
#define WAVETABLE_LEN (HW_SMOTOR_WAVETABLE_LEN + WAVETABLE_LEN)
DEPRECATED_LITERAL_MACRO(MAX_MOI, "MAX_MOI is deprecated, use HW_SMOTOR_MAX_MOI instead")
#define MAX_MOI (HW_SMOTOR_MAX_MOI + MAX_MOI)
DEPRECATED_LITERAL_MACRO(MAX_CYCLIC_SIZE, "MAX_CYCLIC_SIZE is deprecated, use HW_SMOTOR_FIFO_SIZE instead")
#define MAX_CYCLIC_SIZE (HW_SMOTOR_FIFO_SIZE + MAX_CYCLIC_SIZE)
DEPRECATED_LITERAL_MACRO(MAX_IRQ_THRESHOLD, "MAX_IRQ_THRESHOLD is deprecated")
#define MAX_IRQ_THRESHOLD (0x1F + MAX_IRQ_THRESHOLD)
DEPRECATED_LITERAL_MACRO(PGs_NUM, "PGs_NUM is deprecated, use HW_SMOTOR_NOF_PG instead")
#define PGs_NUM (HW_SMOTOR_NOF_PG + PGs_NUM)
...
#define HW_SMOTOR_FIFO_SIZE             64
#define HW_SMOTOR_MAX_ADDITIONAL_CMD    19
#define HW_SMOTOR_WAVETABLE_LEN         48
#define HW_SMOTOR_MAX_MOI               0x3FF
#define HW_SMOTOR_NOF_PG                5
...
typedef struct {
        ...
        hw_smotor_pg_cfg_t *pg_cfg[HW_SMOTOR_NOF_PG];   /**< PG configuration pointers */
} hw_smotor_cfg_t;
...
{
        uint16_t newCommand;
        ASSERT_WARNING(N_CMDs < HW_SMOTOR_MAX_ADDITIONAL_CMD);
        ASSERT_WARNING(W_PTR < HW_SMOTOR_WAVETABLE_LEN - 4);
...
{
        ASSERT_WARNING(cyclic_size < HW_SMOTOR_FIFO_SIZE);
...
{
        ASSERT_WARNING(index <= HW_SMOTOR_FIFO_SIZE);
...
{
        ASSERT_WARNING(moi_value < HW_SMOTOR_MAX_MOI);

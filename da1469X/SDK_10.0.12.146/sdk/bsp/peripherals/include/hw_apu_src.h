 ...
 */
typedef enum {
        HW_APU_SRC_INVALID_DEVICE = 0, /**< Invalid interface */
 ...
 *
 * \param[in] src_clk         SRC clock in kHz. SRC clock must be 32000 kHz due to hardware limitation on DA1469x.
...
/**
 * \brief Clear input data registers and the SRC over/underflow indications
 */

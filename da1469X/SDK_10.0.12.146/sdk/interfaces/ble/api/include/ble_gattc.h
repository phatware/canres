 ...
 *
 */
static inline ble_error_t ble_gattc_indication_cfm(uint16_t conn_idx, uint16_t handle);
static inline __attribute__((deprecated("This function is deprecated and has no effect. "
                                        "All indications are confirmed by the BLE framework immediately after reception.")))
